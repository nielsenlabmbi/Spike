classdef thresholdGui_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        chkbox_copyToZ        matlab.ui.control.CheckBox
        ...
        button_plussec        matlab.ui.control.Button
        button_minussec       matlab.ui.control.Button
    ...
    properties (Access = private)
        ...
        filterCorr %offset at start to fix filter issue
    ...
    methods (Access = private)
        ...
        function refreshSnippet(app,getNew)
            ...
            tc=filter(app.butterParams.b1, app.butterParams.a1, app.snippet(app.currentChannel,:));
            app.currentTc = tc(app.filterCorr:end); %to avoid filter artefact at start
            app.signalLineHandle = plot(app.axis_snippet,linspace(0,1,app.sampleFreq-app.filterCorr+1)+app.slider_time.Value,app.currentTc,'k');
        ...
        function refreshChannel(app)
            ...
            if app.currentProbeNum == 2
                app.text_channelNum.Value = app.currentChannel-app.probe(1).nChannels;
            else
        ...
        function getNewTimeCourse(app)
            ...
            tc=filter(app.butterParams.b1, app.butterParams.a1, tc);
            app.timeCourse=tc(app.filterCorr:end); %there is an artefact at the start because of the filtering
            clear tc;
        end
        ...
        function refreshTimeCourse(app)
            ...
            plot(app.axis_timecourse,linspace(app.currentStart,app.currentStart+app.settings.lengthTC,app.settings.lengthTC*app.sampleFreq-app.filterCorr+1),app.timeCourse,'k');
    ...
    methods (Access = private)
        ...
        function button_getExptPushed(app, event)
            ...
            app.text_gotoTime.Enable=1;
            app.button_minussec.Enable=1;
            app.button_plussec.Enable=1;
            app.check_channel.Enable=1;
        end
        ...
        % Button pushed function: button_minussec
        function button_minussecButtonPushed(app, event)
            currentTime=app.slider_time.Value;
            newTime=max(currentTime-1,0);
            
            app.slider_time.Value=newTime;
            app.text_gotoTime.Value=round(newTime);
        ...
        % Button pushed function: button_plussec
        function button_plussecButtonPushed(app, event)
            currentTime=app.slider_time.Value;
            newTime=min(currentTime+1,app.slider_time.Limits(2));
        ...
        function button_saveButtonPushed(app, event)
            ...
            save(fullfile(app.settings.expFolder,app.exptName,[app.exptName '_threshold.mat']),'thresholding');
            save(fullfile(app.settings.expFolder,app.exptName,[app.exptName '_id.mat']),'id');
            if app.chkbox_copyToZ.Value==1
                fpart=strsplit(app.exptName,'_');          
                zbase='Z:\EphysNew\data';
                save(fullfile(zbase,fpart{1},app.exptName,[app.exptName '_id.mat']),'id');
                save(fullfile(zbase,fpart{1},app.exptName,[app.exptName '_threshold.mat']),'thresholding');
            end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.button_save.Position = [10 9 116 22];
            ...
            app.SettingsButton.Position = [160 98 100 22];
            app.SettingsButton.Text = 'Settings';

            % Create chkbox_copyToZ
            app.chkbox_copyToZ = uicheckbox(app.panel_location);
            app.chkbox_copyToZ.Text = 'Copy to Z';
            app.chkbox_copyToZ.Position = [144 9 74 22];
            app.chkbox_copyToZ.Value = true;
            ...
            app.GotosEditFieldLabel.Position = [550 83 52 22];
            ...
            app.text_gotoTime.Enable = 'off';
            app.text_gotoTime.Position = [552 62 51 22];
            ...
            app.check_channel.Enable = 'off';
            app.check_channel.Text = 'Checked channel';
            app.check_channel.Position = [362 516 115 22];

            % Create button_minussec
            app.button_minussec = uibutton(app.panel_signal, 'push');
            app.button_minussec.ButtonPushedFcn = createCallbackFcn(app, @button_minussecButtonPushed, true);
            app.button_minussec.Enable = 'off';
            app.button_minussec.Position = [523 62 22 22];
            app.button_minussec.Text = '<';

            % Create button_plussec
            app.button_plussec = uibutton(app.panel_signal, 'push');
            app.button_plussec.ButtonPushedFcn = createCallbackFcn(app, @button_plussecButtonPushed, true);
            app.button_plussec.Enable = 'off';
            app.button_plussec.Position = [607.5 62 25 22];
            app.button_plussec.Text = '>';
